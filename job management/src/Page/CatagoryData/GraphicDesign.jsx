                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-center">
                            ...
                            <Link className="w-full" to={`/jobs/${_id}`}>
                                <button className=" border py-2 w-full rounded-lg mt-4 border-blue-500 hover:bg-lime-400 ">Bid now</button>
                            </Link>
                        </div>
                    </div>
                </div>
